        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <select value={status} onChange={(event) => { setStatus(event.target.value); setPage(0); setCheckedIds([]); }} className={inputClass} aria-label="상태 필터">
              <option value="">상태 전체</option><option value="normal">정상출근</option><option value="late">지각</option><option value="earlyLeave">조퇴</option><option value="overtime">추가근무</option><option value="absent">결근</option><option value="leave">휴가</option><option value="unknown">미확인</option>
            </select>
